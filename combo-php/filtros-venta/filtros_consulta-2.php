                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-4 mod">
        ...
        function action_continue() {
           ...
           // }
            ...
            //     }else{
                    ...
                    //                 }
                    //                 if(of_origen!="" && of_destino!=""){
                    //                     var url = "https://venta.etn.com.mx/request.aspx?APPNAME=Navegante&PRGNAME=AccesoEx&ARGUMENTS=-AMA,-A"+TipoDispositivo+",-A"+of_origen+",-A"+of_destino+",-A"+fecha_ida+",-A1,-A0,-A0,-A0,-A0,-A"+V+",-A,-A,-A,-AES,-A,-A,-A,-A,-A,-ANO,-A,-A,-A,-A,-A,-A,-ANO";
                    //                     //window.location=url;
                    //                     window.top.location.href=url;
                    //                 }
                    //         }
